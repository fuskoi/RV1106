...
# 	Board Config
#################################################
export LF_ORIGIN_BOARD_CONFIG=BoardConfig-SPI_NAND-Buildroot-RV1106_PangHuV1-IPC.mk
# Target CHIP
...
# Kernel dts
export RK_KERNEL_DTS=rv1106g-panghu-v1.dts
...
# Buildroot defconfig
export RK_BUILDROOT_DEFCONFIG=panghu_v1_buildroot_defconfig
...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=panghu_v1_rv1106_uboot_defconfig

# Kernel defconfig
export RK_KERNEL_DEFCONFIG=panghu_v1_rv1106_kernel_defconfig

# Config sensor IQ files
# RK_CAMERA_SENSOR_IQFILES format:
#     "iqfile1 iqfile2 iqfile3 ..."
# ./build.sh media and copy <SDK root dir>/output/out/media_out/isp_iqfiles/$RK_CAMERA_SENSOR_IQFILES
export RK_CAMERA_SENSOR_IQFILES="sc3336_CMK-OT2119-PC1_30IRC-F16.json imx219_default_defconfig.json"
