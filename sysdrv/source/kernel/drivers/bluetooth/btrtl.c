...
static const struct id_table ic_id_table[] = {
	...
	{ .match_flags = IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_HCIREV |
	  ...
	  .fw_name  = "rtlbt/rtl8723bs_fw.bin",
	  .cfg_name = "rtlbt/rtl8723bs_config" },

	/* 8723B */
	{ IC_INFO(RTL_ROM_LMP_8723B, 0xb),
	  .config_needed = false,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8723b_fw.bin",
	  .cfg_name = "rtlbt/rtl8723b_config" },

	/* 8723D */
	{ IC_INFO(RTL_ROM_LMP_8723B, 0xd),
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8723d_fw.bin",
	  .cfg_name = "rtlbt/rtl8723d_config" },
	...
	{ .match_flags = IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_HCIREV |
	  ...
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8723ds_fw.bin",
	  .cfg_name = "rtlbt/rtl8723ds_config" },
	...
	{ IC_INFO(RTL_ROM_LMP_8821A, 0xa),
	  .config_needed = false,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8821a_fw.bin",
	  .cfg_name = "rtlbt/rtl8821a_config" },

	/* 8821C */
	{ IC_INFO(RTL_ROM_LMP_8821A, 0xc),
	  .config_needed = false,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8821c_fw.bin",
	  .cfg_name = "rtlbt/rtl8821c_config" },

	/* 8761A */
	{ IC_INFO(RTL_ROM_LMP_8761A, 0xa),
	  .config_needed = false,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8761a_fw.bin",
	  .cfg_name = "rtlbt/rtl8761a_config" },

	/* 8761B */
	{ IC_INFO(RTL_ROM_LMP_8761A, 0xb),
	  .config_needed = false,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8761b_fw.bin",
	  .cfg_name = "rtlbt/rtl8761b_config" },
	...
	{ .match_flags = IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_HCIREV |
	  ...
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8822cs_fw.bin",
	  .cfg_name = "rtlbt/rtl8822cs_config" },

	/* 8822C with USB interface */
	{ IC_INFO(RTL_ROM_LMP_8822B, 0xc),
	  .config_needed = false,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8822cu_fw.bin",
	  .cfg_name = "rtlbt/rtl8822cu_config" },

	/* 8822B */
	{ IC_INFO(RTL_ROM_LMP_8822B, 0xb),
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtlbt/rtl8822b_fw.bin",
	  .cfg_name = "rtlbt/rtl8822b_config" },
	};
...
MODULE_LICENSE("GPL");
MODULE_FIRMWARE("rtlbt/rtl8723a_fw.bin");
MODULE_FIRMWARE("rtlbt/rtl8723b_fw.bin");
MODULE_FIRMWARE("rtlbt/rtl8723b_config.bin");
MODULE_FIRMWARE("rtlbt/rtl8723bs_fw.bin");
MODULE_FIRMWARE("rtlbt/rtl8723bs_config.bin");
MODULE_FIRMWARE("rtlbt/rtl8723ds_fw.bin");
MODULE_FIRMWARE("rtlbt/rtl8723ds_config.bin");
MODULE_FIRMWARE("rtlbt/rtl8761a_fw.bin");
MODULE_FIRMWARE("rtlbt/rtl8761a_config.bin");
MODULE_FIRMWARE("rtlbt/rtl8821a_fw.bin");
MODULE_FIRMWARE("rtlbt/rtl8821a_config.bin");
MODULE_FIRMWARE("rtlbt/rtl8822b_fw.bin");
MODULE_FIRMWARE("rtlbt/rtl8822b_config.bin");
